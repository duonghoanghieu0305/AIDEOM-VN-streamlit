...
4. TRÌNH BÀY: Dùng **in đậm** từ khóa. Súc tích, giọng điệu học thuật.`;
  ...
  if (chatHistory.length === 0) {
    addMsg('bot', `Chào bạn! Tôi là Giáo sư AI của hệ thống. Tôi nhận thấy bạn đang xem **${currentPageTitle}**.\n\nTrong bài tập này, chúng ta không chỉ giải bài toán tối ưu mà còn phải phân tích kết quả dựa trên các chiến lược quốc gia (như QĐ 127/QĐ-TTg, NQ 57-NQ/TW). Bạn cần tôi hỗ trợ phần nào?`, false);
  } else {
